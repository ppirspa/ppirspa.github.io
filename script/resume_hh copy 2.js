...
function updateResume_HH_Data(){
    ...
    var threeMonth = {
        0: {
            ...
            byMoment: {mo1:{act:0,opp:0,score:""},mo2:{act:0,opp:0,score:""},mo3:{act:0,opp:0,score:""},mo4:{act:0,opp:0,score:""},mo5:{act:0,opp:0,score:""},total:{act:0,opp:0,score:""}},
            byProfesi: {"Dokter":{act:0,opp:0,score:""},"Perawat Bidan":{act:0,opp:0,score:""},"Magang Siswa":{act:0,opp:0,score:""},"Lain-lain":{act:0,opp:0,score:""}}
        },
        1: {
    ...
    while(iData < len){
        ...
        //     }
        //     if(item.month*1 === threeMonth[nMonth].month && ((resumeFilter.hh.unit == "All") ? (item.unit !== "") : (item.unit == resumeFilter.hh.unit))){
                
        //         if(item.mo1 !== ""){threeMonth[nMonth].}
        //     }
        // nMonth++
        // }
    iData++
...
function updateResume_HH_Chart(){
    ...
    if(scrollMonthIndex < 0){
        ...
        scrollMonth = ((x * 1) - 3 )  / resumeHHData.chart.chart3.labels.length * (Elem("res-hh-canvas-3").offsetWidth * 1) 
    }
